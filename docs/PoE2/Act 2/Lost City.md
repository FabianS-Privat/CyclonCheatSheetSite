...
```mermaid
graph TD;
A[Move opposite to the Entrance]-->|found Bridge|B[continue to move opposite to the Entrance]
A-->|found Middle Wall|C[Check both ends of it for the Bridge]
C-->B
B-->|Found Opposite Edge to the Entrance|D[Check for Winged Exit Tile]
```
...
| --------------------------------------------------------- | --------------------------------------------------------- |
| ![Lost City 1](<./img/Lost%20City/Lost%20City%20(1).png>) | ![Lost city 2](<./img/Lost%20City/Lost%20City%20(2).png>) |
