...
```mermaid
graph TD;
A[Move Straitgh opposite to the Entrance]-->|Reached Spire Section|B[Look for green Bile around the Start of the Section to find Arena]
B-->|found Arena|C[Head to the Opposite Edge to Entrance]
C-->|found Edge|D[Search for Exit]
D-->|found Exit|E[Head back into the Zone and search around every Spire for fallen Dekhara]
```
