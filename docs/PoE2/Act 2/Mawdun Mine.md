...
```mermaid
graph TD;
A[Follow the Tunnel]-->|Zone opens up|B[Take the Left Path]
B-->|Another Fork|C[Take the Right Path]
C-->|Another Fork|B
B-->|See the Boss Room Checkpoint or Circle Tile|D[Enter Boss Room]
C-->|See the Boss Room Checkpoint or Circle Tile|D
...
|                                                               |
| ------------------------------------------------------------- |
| ![Mawdun Mine](<./img/Mawdun%20Mine/Mawdun%20Mine%20(2).png>) |
