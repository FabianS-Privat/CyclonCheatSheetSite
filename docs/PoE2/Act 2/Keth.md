...
```mermaid
graph TD;
A[Follow the Waypoint Edge]-->|found Venom Pit|B[Move directly to Exit in diagonal Path to opposite Edge of the WP Edge]
A-->|See Stone Tiles on the Ground|C[Search for Kabala away from the WP Edge in the 2nd Third of the Zone,after head to opposite Edge of the WP Edge]
C-->D[Follow Edge till reaching Exit]
B-->D
D-->|Optional|E[Follow the other Edge away from Exit to find the correct Abandoned Shrine]
D-->|Haven't found Kabala Clan Relic|F[Seek and kill Snake Type Enemies in the Stone Tile Section of the Zone]
```
...
| -------------------------------------- | -------------------------------------- | -------------------------------------- |
| ![Keth 1](<./img/Keth/Keth%20(1).png>) | ![Keth 2](<./img/Keth/Keth%20(2).png>) | ![Keth 3](<./img/Keth/Keth%20(3).png>) |
