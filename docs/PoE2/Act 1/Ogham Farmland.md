...
```mermaid
graph TD;
A[Follow Direct Path]-->|Wagon Tile before reaching Una's Hut|B[Circle around Wagon Tile to reach Una's Hut]
A-->|Una's Hut before Wagon Tile|C[Find and circle Wagon Tile]
C-->Z[Follow the Road till it ends]
Z-->|Found Corn Circle|D[Find Path to Exit Tile behind Corn Circle]
Z-->|No Corn Circle|E[Circle around Blockage and find Exit Tile]
B-->F[Check the Fork first]
F-->|Short Fork with Dead End|G[Return to Una's Hut and follow the Main Path]
G-->Z
F-->|Long Fork with Dead End|H[Follow the new Fork of the first Fork]
H-->Z
F-->|Short Fork, but Terrain behind the Dead End|I[Find closest Connection through the Weat Fields till you find a Dirt Road behind the Dead End again]
I-->X[Find the Exit Tile]
```
...
| ----------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| ![Ogham Farmlands Overworld](<./img/Ogham%20Farmlands/Ogham%20Farmlands%20Overworld%20(1).png>) | ![Ogham Farmlands Overworld 2](<./img/Ogham%20Farmlands/Ogham%20Farmlands%20Overworld%20(2).png>) |
...
|                                                                                                                                    | Special Case both Path end near the Exit ![Ogham Farmlands 5](<./img/Ogham%20Farmlands/Ogham%20Farmlands%20(5).png>) |
